    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_type', models.CharField(default='P', max_length=1, verbose_name='Background type', choices=[('', 'Banner'), ('P', 'Pattern')])),
                ('image', models.ImageField(help_text='The image file', upload_to='images')),
                ('created_by', models.ForeignKey(related_name='assets_image_creations', to=settings.AUTH_USER_MODEL, help_text='The user which originally created this item')),
                ('modified_by', models.ForeignKey(related_name='assets_image_modifications', to=settings.AUTH_USER_MODEL, help_text='The user which last modified this item')),
