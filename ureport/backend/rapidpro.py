...
class ContactSyncer(BaseSyncer):
    ...
    def local_kwargs(self, org, remote):
        ...
        reporter_group = org.get_config('%s.reporter_group' % self.backend, default='')
        ...
        state_field = org.get_config('%s.state_label' % self.backend, default='')
        if state_field:
            ...
            if org.get_config('common.is_global'):
                ...
                district_field = org.get_config('%s.district_label' % self.backend, default='')
                if district_field:
                ...
                ward_field = org.get_config('%s.ward_label' % self.backend, default='')
                if ward_field:
        ...
        registered_on = None
        registration_field = org.get_config('%s.registration_label' % self.backend, default='')
        ...
        occupation = ''
        occupation_field = org.get_config('%s.occupation_label' % self.backend, default='')
        if occupation_field:
        ...
        born = 0
        born_field = org.get_config('%s.born_label' % self.backend, default='')
        if born_field:
        ...
        gender = ''
        gender_field = org.get_config('%s.gender_label' % self.backend, default='')
        female_label = org.get_config('%s.female_label' % self.backend, default='')
        male_label = org.get_config('%s.male_label' % self.backend, default='')
