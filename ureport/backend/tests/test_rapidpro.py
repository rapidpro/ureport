...
class BoundarySyncerTest(UreportTest):
    ...
    def setUp(self):
        ...
        self.syncer = BoundarySyncer(backend='rapidpro')
        self.syncer2 = BoundarySyncer(backend='floip')
...
class ContactSyncerTest(UreportTest):
    ...
    def test_local_kwargs(self):
        ...
        self.assertEqual(self.syncer2.local_kwargs(self.nigeria, temba_contact),
                         {'backend': 'floip',
                          'org': self.nigeria,
                          'uuid': 'C-008',
                          'gender': 'M',
