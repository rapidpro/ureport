    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_type', models.CharField(max_length=1, choices=[('T', 'Twitter'), ('F', 'Facebook'), ('R', 'RSS')])),
                ('source_url', models.URLField()),
                ('widget_id', models.CharField(max_length=50, null=True, blank=True)),
                ('is_featured', models.BooleanField(default=False)),
                ('created_by', models.ForeignKey(related_name='jobs_jobsource_creations', to=settings.AUTH_USER_MODEL, help_text='The user which originally created this item')),
                ('modified_by', models.ForeignKey(related_name='jobs_jobsource_modifications', to=settings.AUTH_USER_MODEL, help_text='The user which last modified this item')),
