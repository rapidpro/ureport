...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='is_featured',
            field=models.BooleanField(default=False, help_text='Featured job sources are shown first on the jobs page.'),
        ...
        migrations.AlterField(
            model_name='jobsource',
            name='widget_id',
            field=models.CharField(help_text='For Twitter, a widget Id is required to embed tweets on the website. Read carefully the instructions above on how to get the right widget Id', max_length=50, null=True, blank=True),
            preserve_default=True,
        ),
    ]
