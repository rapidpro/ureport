    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('link', models.CharField(help_text='A link that should be associated with this item', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video_id', models.CharField(help_text='The id of the YouTube video that should be linked to this item', max_length=255)),
                ('category', models.ForeignKey(help_text='The category this item belongs to', to='categories.Category')),
                ('created_by', models.ForeignKey(help_text='The user which originally created this item', to=settings.AUTH_USER_MODEL)),
                ('modified_by', models.ForeignKey(help_text='The user which last modified this item', to=settings.AUTH_USER_MODEL)),
