...
class NewsTest(DashTest):
    ...
    def test_list_newsItem(self):
        ...
        self.nigeria_news1 = NewsItem.objects.create(title='nigeria news 1',
    ...
    def test_update_newsItem(self):
        ...
        post_data = dict(title='title updated', description='description updated',
                         link="http://updated.com", category=self.health_uganda.pk,
                         is_active=False)
...
class VideoTest(DashTest):
    ...
    def test_create_video(self):
        ...
        post_data = dict(title='video 1', description='awesome video',
    ...
    def test_video_update(self):
        ...
        post_data = dict(title='title updated', description='description updated',
                         video_id="newID", category=self.health_uganda.pk,
                         is_active=False)
