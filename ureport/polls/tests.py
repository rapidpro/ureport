...
class PollTest(DashTest):
    ...
    def test_best_and_worst(self):
        ...
        with patch('temba.TembaClient.get_flow_results') as mock:
            ...
            mock.assert_called_once_with(poll1_question.ruleset_uuid, segment=dict(location="State"))
...
class PollQuestionTest(DashTest):
    ...
    def test_poll_question_model(self):
        ...
        with patch('temba.TembaClient.get_flow_results') as mock:
            ...
            mock.assert_called_with(poll_question1.ruleset_uuid, segment=dict(location='State'))
