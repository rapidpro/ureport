...
PREVIOUS_ORG_SITES = [
    dict(
        ...
        flag="flag_ar.png",
        is_static=True,
        count_link="argentina.ureport.in/count/",
    ),
    dict(
        name="Brazil",
        ...
        flag="flag_br.png",
        is_static=True,
        count_link="ureportbrasil.org.br/count/",
    ),
    dict(
        name="El Salvador",
        ...
        flag="flag_sv.png",
        is_static=True,
        count_link="elsalvador.ureport.in/count/",
    ),
    dict(
        name="Guatemala",
        ...
        flag="flag_gt.png",
        is_static=True,
        count_link="guatemala.ureport.in/count/",
    ),
    dict(
        name="France",
        ...
        flag="flag_fr.png",
        is_static=True,
        count_link="france.ureport.in/count/",
    ),
    dict(
        name="Ireland",
        ...
        flag="flag_ir.png",
        is_static=True,
        count_link="ireland.ureport.in/count/",
    ),
    dict(
        name="Moldova",
        ...
        flag="flag_md.png",
        is_static=True,
        count_link="moldova.ureport.in/count/",
    ),
    dict(
        name="New Zealand",
        ...
        flag="flag_nz.png",
        is_static=True,
        count_link="newzealand.ureport.in/count/",
    ),
    dict(
        name="Syria",
        ...
        flag="flag_sy.png",
        is_static=True,
        count_link="syria.ureport.in/count/",
    ),
    dict(
        name="Thailand",
        ...
        flag="flag_th.png",
        is_static=True,
        count_link="thailand.ureport.in/count/",
    ),
    dict(
        name='United Kingdom',
        host="//uk.ureport.in",
        flag="flag_uk.png",
        is_static=True,
        count_link="uk.ureport.in/count/",
    ),
    dict(
        name="Zambia",
        ...
        flag="flag_zm.png",
        is_static=True,
        count_link='www.zambiaureport.com/count.txt/',
    ),
]
