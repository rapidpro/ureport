...
BEGIN
    ...
    UPDATE stats_contactactivity SET born = _poll_result.born, gender = _poll_result.gender, state = _poll_result.state, district = _poll_result.district, ward = _poll_result.ward WHERE org_id = _poll_result.org_id and contact = _poll_result.contact; 
END;
$$ LANGUAGE plpgsql;
