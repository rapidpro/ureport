...
urlpatterns = [
    ...
    re_path(r"^v2/manage/", include("ureport.syncjobs.urls")),
    re_path(r"^v2/users/", include("ureport.users.urls")),
    ...
    re_path(r"^v1/manage/", include("ureport.syncjobs.urls")),
    re_path(r"^v1/users/", include("ureport.users.urls")),
    ...
    re_path(r"^manage/", include("ureport.syncjobs.urls")),
    re_path(r"^users/", include("ureport.users.urls")),
